...
- **Right-click an event** to pick a colour for:
  - **every event in the same course.** Titles that start with a course code are recognized, like `2100-Microeconomics (Lecture 4)`, `BIO 101 Lab` or `CS-2100 Tutorial`.
...
- **Does not replace Notion's pop-up menu.** Single-click opens the Notion menu; right-click opens the twotone menu.
...
### [usage and permissions](usage-and-permissions.md)
